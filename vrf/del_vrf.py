...
def run(gobgpd_addr, vrf_name, route_dist, import_rt, export_rt):
    ...
    with gobgp_pb2.beta_create_GobgpApi_stub(channel) as stub:
        ...
        export_rts = []
        bin_export_rt = str_to_bin_for_rd(export_rt)
...
def str_to_bin_for_rt(route_target):
        ...
        rt_tmp = BGPTwoOctetAsSpecificExtendedCommunity(subtype=0, as_number=as_number, local_administrator=local_administrator)
